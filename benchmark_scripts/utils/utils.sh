...
alias whatsgood="cd $PROJ_HOME/benchmark_scripts/profiling_data/exp_results; ls -t; cat * */*;cd $PROJ_HOME"
...
alias solo_party="cd $PROJ_HOME/playbooks; ansible-playbook -i ../inventory_local"
alias killsolrj='cd $PROJ_HOME;pssh -i -h ssh_files/pssh_traffic_node_file -l $CL_USER $KILLARGS'
alias clearout="cd $PROJ_HOME/benchmark_scripts; echo ''> nohup.out"
alias viewout="cd $PROJ_HOME/benchmark_scripts; tail -n 1000 nohup.out"
...
alias singletest="cd $PROJ_HOME/benchmark_scripts; bash exp_scale_loop_single.sh"
alias fulltest="cd $PROJ_HOME/benchmark_scripts; bash exp_scale_loop.sh"
alias dockertest="cd $PROJ_HOME/benchmark_scripts; bash exp_scale_loop_docker.sh"
...
alias daparams="vim $PROJ_HOME/benchmark_scripts/utils/exp_scale_loop_params.sh"
