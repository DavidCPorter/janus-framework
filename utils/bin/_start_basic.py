...
#             if m_instance.name == start_mod:
#                 mod_commence = True
#             else:
#                 pass
#             if mod_commence == True:
#                 for p in m_instance.play_order.items():
#                     if p == start_play:
#                         play_commence = True
#                     else:
#                         pass
#                 if play_commence == True:
#
#
#
#
...
#     inv = dfs_dict.get('--inv', '/Users/dporter/projects/sapa/local_var_inventory')
