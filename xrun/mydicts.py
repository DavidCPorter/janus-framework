...
def getAdHocDict():
    d = dict()
    d['copyscripts'] = "--hosts generatorNode --play copy_scripts.yml --vars ui_sapa_vars.yml --module http_closed_loop --inv /Users/dporter/projects/sapa/inventory_local --tags activate --stage load"
    ...
    d['cdf']  = "--hosts localhost --play generate_cdf.yml --vars ui_sapa_vars.yml --module cdf --inv /Users/dporter/projects/sapa/inventory_local --tags activate --stage viz"
    return d
